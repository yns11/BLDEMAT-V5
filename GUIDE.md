...
| Installation existante (déjà en V001) | `sql/migrations/V002__notifications_directes.sql` |
...
> **Mentions** : la carte contient le jeton `<at>Nom</at>` et l'entité
> `msteams.entities` avec l'e-mail. Si les mentions n'apparaissent pas en
> cliquables, ouvrir le flux dans Power Automate et vérifier que l'étape de
> publication transmet bien le corps reçu **tel quel** (`Body` du déclencheur)
> à l'action « Publier une carte adaptative dans un canal ».
...
| Une mention n'est pas cliquable | Vérifier l'e-mail dans Gestion ▸ Gestionnaires et l'appartenance de la personne au canal Teams. |
