...
from bl_core import extraction, images, rbac, repository, ui, validation
...
# =====================================================================
    ...
    if photo_brute is not None:
        ...
        try:
            ...
            st.image(page_traitee, caption=f"Aperçu — {mode}", use_container_width=True)
            ...
            with st.expander("Voir la photo originale"):
                try:
                    st.image(photo_brute, use_container_width=True)
                except Exception:
