...
from bl_core import notifications, pdf_bl, rbac, repository, ui
...
def render_vue_courante() -> None:
    ...
    if vue == VUE_DASHBOARD:
        ...
        st.caption("L'**e-mail** (UPN Microsoft 365) permet de @mentionner le "
                   "gestionnaire dans les cartes Teams des nouvelles réceptions "
                   "de son portefeuille. Le **nom affiché** est le texte de la "
                   "mention (à défaut, le code est utilisé). Sans e-mail, le "
                   "gestionnaire est cité sans être notifié.")
        vue_referentiel(
            "gestionnaires",
            vue,
            config_colonnes={
