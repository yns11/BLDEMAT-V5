...
#   flow     : l'app pose le marqueur {{MENTIONS}} et envoie les e-mails ; le
#              flux Power Automate génère les jetons (action « Obtenir un jeton
#              @mention pour un utilisateur ») — SEULE méthode fiable ;
#   entities : l'app écrit elle-même msteams.entities (ne fonctionne que sur
#              certains tenants, souvent rejeté par le Flow bot) ;
#   texte    : noms en clair, aucune mention.
_MENTION_MODES = {"flow", "entities", "texte"}
